# 03 — Scan de sécurité avec Trivy
...
```bash
trivy image --severity HIGH,CRITICAL <IMAGE>                                  # table
...
## Gate de sécurité — seuil ajusté (documenté)

> ⚠️ Le sujet autorise à abaisser le niveau de sécurité si l'image ne passe pas la
> gate, à condition de le documenter.
